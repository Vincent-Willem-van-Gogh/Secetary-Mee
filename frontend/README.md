...
2. Clone the repository and navigate to the frontend directory:
   ```bash
   git clone https://github.com/Vincent-Willem-van-Gogh/Secetary-Mee
...
Secretary Mee does not require a separate FastAPI service, Docker backend, or manually started whisper-server process. Local transcription is handled by the Rust/Tauri desktop app.

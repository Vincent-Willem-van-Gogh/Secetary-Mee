        ...
        <div className="flex-1">
          <div className="flex items-center gap-2 mb-1">
            ...
            <h3 className="text-sm font-semibold text-blue-900">
              {t("Previous Meetily Installation Detected!")}</h3>
          </div>
          <p className="text-sm text-blue-800 mb-2">
            {t("We found an existing database from your previous Meetily installation (Python backend version).")}</p>
          ...
          <p className="text-sm text-blue-800 mb-3">
            {t("Would you like to import your previous meetings, transcripts, and summaries?")}</p>
